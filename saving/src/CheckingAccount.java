public class CheckingAccount extends BankAccount {
	...
	// System.out.println("Payment amount is less than the bill amount. Cannot pay "
	// + amount);
	// } else if (utilityBill.getPaidDate() != null) {
	// System.out.println("Bill " + utilityBill.getBillNumber() + " has already been
	// paid.");
	// } else {
	// balance -= amount;
	// utilityBill.payBill(java.time.LocalDate.now().toString());
	// System.out.println("Paid utility bill " + utilityBill.getBillNumber() + " of
	// amount " + amount);
	// }
	// }
}
